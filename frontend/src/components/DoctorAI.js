...
<Container style={{marginBottom:"8%"}}>
  ...
  <img src={logo} style = {{width:'70px',height:'60px'}}/>
    ...
    <div style={{listStyle:"none",borderStyle:'solid',borderRadius:"50px",paddingBottom:"20%",paddingTop:"12%"}}>
     ...
     <Link to='/DoctorAI' style={{textDecoration:"none"}}> <li style={{color:"white",fontSize:"160%",marginBottom:"5%",textDecoration:"none",textShadow:"2px 2px 4px aliceblue"}}><FontAwesomeIcon  icon={faRobot} size='x'style={{color:"snow"}}/> DoctorAI</li></Link>

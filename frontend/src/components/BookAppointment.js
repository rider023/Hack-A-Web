...
<Container style={{marginBottom:"8%"}}>
  ...
  <img src={logo} style = {{width:'70px',height:'60px'}}alt="img" />
    ...
    <Col  sm={12} md={6} xl={9}>
    <h2 style={{marginBottom:"4%",color:"#B1D0E0"}}><b>BOOK A NEW APPOINTMENT</b></h2>
    <Container>
    <Form >
    <Form.Group className="mb-5"  style={{display:"flex", justifyContent:"center"}}>
    <Form.Label  style={{color:"#B1D0E0",marginRight:"1%"}}>Doctor's Name: </Form.Label>
    <Form.Control type="text" placeholder="Enter Name" style={{minWidth:"200px",borderRadius:"8px",width:"100%"}}/>
    </Form.Group>
     <Form.Group className="mb-5" style={{display:"flex", justifyContent:"center"}}>
    <Form.Label  style={{color:"#B1D0E0",marginRight:"1%"}}>Doctor's Email: </Form.Label>
    ...
    <Form.Label  style={{color:"#B1D0E0",marginRight:"2%"}}>Date: </Form.Label>
    <Form.Control type="date" placeholder="Enter Date" style={{minWidth:"300px",marginRight:"2%",borderRadius:"8px",width:"100%"}}/>
    <Form.Label  style={{color:"#B1D0E0",marginRight:"2%"}}>Time: </Form.Label>
    <Form.Control type="time" placeholder="Enter Time" style={{minWidth:"300px",borderRadius:"8px",width:"100%"}}/>
    </Form.Group>
    <Form.Group className="mb-5" style={{display:"flex", justifyContent:"center"}}>
    ...
    <Form.Control type="text" placeholder="Enter Symptoms" style={{minWidth:"200px",borderRadius:"8px",width:"100%"}}/>
      ...
      <Button style={{marginLeft:"40%",backgroundColor:"#6998AB",padding:"1% 6%",borderRadius:"19px",borderColor:"transparent"}}>Book</Button>
      </Form>
      </Container>
    </Col>
  </Row>

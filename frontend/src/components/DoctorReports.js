...
<Container style={{marginBottom:"8%"}}>
  ...
  <img src={logo} style = {{width:'70px',height:'60px'}}alt="img" />
    ...
    <Col  sm={12} md={6} xl={9}>
    <h2 style={{display:"flex",justifyContent:"space-between",marginBottom:"4%",color:"#B1D0E0"}}><b>REPORTS</b>
    <Link style={{textDecoration:"none",color:"#B1D0E0"}} to="/NewReport"><div style={{fontSize:"60%",textDecoration:"none",color:"#B1D0E0"}}>+Create Report</div></Link></h2>

...
<Container style={{marginBottom:"8%"}}>
  ...
  <img src={logo} style = {{width:'70px',height:'60px'}}alt="img" />
    ...
    <div style={{backgroundColor:"#285373",listStyle:"none",borderStyle:'solid',borderRadius:"50px",paddingBottom:"20%",paddingTop:"12%"}}>
     ...
     <Link to='/DoctorAppointments' style={{textDecoration:"none"}}> <li style={{backgroundColor:"#285373",color:"white",fontSize:"160%",marginBottom:"5%",textDecoration:"none",textShadow:"2px 2px 4px aliceblue"}}><FontAwesomeIcon  icon={faCalendar} size='x'style={{backgroundColor:"#285373",color:"snow"}}/> Appointments</li></Link>
    ...
    <Col  sm={12} md={6} xl={9}>
    <h2 style={{marginBottom:"4%",color:"#B1D0E0"}}><b>DOCTOR APPOINTMENTS</b></h2>
